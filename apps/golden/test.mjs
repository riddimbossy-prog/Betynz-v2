...
assert.match(html,/zeus-board-loading\.jpg/);
...
assert.match(splashCss,/\.board-splash/);
...
assert.ok(existsSync(splashAsset),'Zeus loading artwork must exist');
...
console.log('Golden Banker v4.3 engine + compact UI + crest proxy + highly rated page + Zeus splash tests passed');