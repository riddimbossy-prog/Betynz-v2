...
assert.match(splashCss,/zeus-breathe/);
...
assert.match(splashJs,/canplay/);
assert.match(splashJs,/defaultMuted=true/);
...
console.log('Golden Banker v4.3 engine + compact UI + crest proxy + highly rated page + direct Zeus video splash tests passed');