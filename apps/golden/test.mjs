...
assert.match(splashJs,/zeus-thunder\.part01/);
assert.match(splashJs,/new Blob\(\[bytes\],\{type:'video\/mp4'\}\)/);
assert.match(splashJs,/URL\.createObjectURL/);
assert.match(splashJs,/URL\.revokeObjectURL/);
...
console.log('Golden Banker v4.3 engine + compact UI + crest proxy + highly rated page + Zeus video splash tests passed');