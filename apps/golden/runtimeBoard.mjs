...
export function hasExactEvidence(analysis){
  ...
  return analysis?.evidence?.homeLast5?.length===5&&analysis?.evidence?.awayLast5?.length===5&&Boolean(analysis?.markets?.under35);
}
