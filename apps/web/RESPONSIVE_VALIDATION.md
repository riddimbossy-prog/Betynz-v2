...
The cinematic UI and CSS are unchanged from the previously rendered full-device baseline. Those headless Chromium screenshots and 105 layout results remain included in this package. For v3.8.0, the responsive source assertions and local page/API smoke tests were rerun after the custom-data-API data migration.
