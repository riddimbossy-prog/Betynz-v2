...
function engineName(code) { if (code === 'PPG_ROUTE') return 'PPG Route Engine'; if (code === 'APEX_INTELLIGENCE') return 'Apex Intelligence Engine'; if (code === 'CONVERGENCE_ROUTE') return 'Convergence Engine'; if (code === 'MOMENTUM_STREAK') return 'Momentum & Streak Engine'; if(code==='CONSENSUS_SYSTEM') return 'Consensus System'; return 'Market Route Engine'; }
function table(rows) {
