...
const SPLASH_KEY = 'betynz:pwa-splash:5.0.18';
...
function showLaunchSplash() {
  ...
  splash.innerHTML = `<div class="pwa-splash-bolt"></div><div class="pwa-splash-core"><img src="/assets/betynz-mark.png" alt=""><strong>BETYNZ<span>.com</span></strong><small>SEVEN ENGINES · ZEUS SUPERVISION</small><i></i></div>`;
