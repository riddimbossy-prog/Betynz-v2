-- Betynz v3.5 fresh database schema with three engines, consensus and calibration.
...
create table if not exists public.engine_predictions (
  ...
  engine text not null check (engine in ('MARKET_ROUTE','PPG_ROUTE','CONVERGENCE_ROUTE')),
